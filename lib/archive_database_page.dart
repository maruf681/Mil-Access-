...
class ArchiveDatabasePageState extends State<ArchiveDatabasePage> {
  ...
  void _showAddDocumentDialog(BuildContext context) {
    ...
    String? _selectedClassification = 'Unclassified';
                ...
                if (_titleController.text.isNotEmpty &&
                  ...
                  setState(() {
                    documents.insert(0, {
                      ...
                      'classification':
                          _selectedClassification ?? 'Unclassified',
                      'content':
                          'DOCUMENT: ${_titleController.text}\n\n'
                          'CATEGORY: $_selectedCategoryForAdd\n'
                          'AUTHOR: ${_authorController.text.isNotEmpty ? _authorController.text : 'Unknown'}\n'
                          'VERSION: ${_versionController.text.isNotEmpty ? _versionController.text : 'v1.0'}\n'
                          'CLASSIFICATION: ${_selectedClassification ?? 'Unclassified'}\n'
                          'DATE CREATED: ${DateTime.now().toString().substring(0, 10)}\n\n'
                          'DESCRIPTION:\n${_descriptionController.text.isNotEmpty ? _descriptionController.text : 'No description available'}\n\n'
